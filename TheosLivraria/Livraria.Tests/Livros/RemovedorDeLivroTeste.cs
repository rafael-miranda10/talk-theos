...
namespace Livraria.Tests.Livros
{
    public class RemovedorDeLivroTeste
    {
        ...
        [Fact]
        public async void DeveRemoverLivro()
        {
            //arrange
            ...
            //act
            await _removedorDeLivro.Remover(livro.Id);
        ...
        [Fact]
        public async void NaoDeveRemoverLivro()
        {
            //arrange
            Livro livro = null;
            ...
            //act
            await _removedorDeLivro.Remover(Constantes.Um);
